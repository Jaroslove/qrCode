...
namespace MessagingToolkit.QRCode.Codec
{
  public class QRCodeEncoder
  {
    ...
    internal static string DEFAULT_ENCODING = "UTF-8";
    ...
    {
      return this.Encode(content, Encoding.GetEncoding(this.CharacterSet));
    }
    ...
    {
      XmlTextReader xmlTextReader = new XmlTextReader(QRCodeEncoder.GetEmbeddedFile(fileName));

namespace MessagingToolkit.QRCode.Codec.Ecc
{
    public class BCH15_5
    {
      ...
      "d4"
        ...
        {
            return this.CorrectErrorBit(this.receiveData, this.DetectErrorBitPosition(this.CalcSyndrome(this.receiveData)));
        }
        ...
        internal virtual int[][] CreateGF16()
        {
            ...
            int[] numArray = new int[4] { 1, 1, 0, 0 };
        ...
        {
            int[] numArray = new int[4] { s[0], 0, 0, 0 };
            int num1 = (s[0] + s[1]) % 15;
